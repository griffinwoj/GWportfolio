...
const Navigation = () => {
  return (
    ...
    <Navbar bg="dark" variant="dark" expand="lg" sticky="top" className="py-0.5 mt-0">
      <Container>
        <Navbar.Brand as={Link} to="/7homas7he7ank-react-portfolio/">Griffin Wojtowicz</Navbar.Brand>
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            {/*  */}
            <Nav.Link as={Link} to="src/components/About.js" className="fs-5 nav-link-highlight shadow-lg">About Me!</Nav.Link>
